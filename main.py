...
U-M Account Management at https://password.it.umich.edu.<br>
<br>
...
<p>Welcome to the ICPSR Summer Program!</p></body></html>
"""
participant_msg = """\
Content-Type: text/html
From: {}
To: {}
Subject: ICPSR Summer Program: Information Technology, Participant Preparation
This message is sent to you on behalf of ICPSR Summer Program Computing Support. Please retain it for future 
reference.<br>
<br>
To ensure that messages from ICPSR Summer Program Computing Support are not flagged as spam by your email application, 
please add the following email address to your contact list: icpsr-sptechsupp@umich.edu.<br> 
<br>
We are writing to provide you with important information about the University of Michigan account credentials that 
you will use to participate in your short workshop(s).<br>
<br>
A U-M uniqname, UMICH password, and enrollment in Duo two-factor authentication are required for participation in 
the ICPSR Summer Program.<br>
<br>
If you are not a regular University faculty, staff or student and if you have not already received a U-M uniqname, 
...
instructions for each option, visit https://documentation.its.umich.edu/2fa/options-two-factor-authentication. 
To enroll a device in Duo or to manage your Duo devices, visit U-M Account Management at https://password.it.umich.edu.
<br>
<b>All participants must</b> visit the main Summer Program Canvas site and review the module titled 
...
additional steps that you must take to prepare for participation in the Program.<br>
<i>Failure to complete these tasks in advance will impede your participation in Summer Program instructional 
activities</i>.<br>
<br>
Your access to Summer Program Canvas resources will expire at 12:00 AM Eastern Daylight Time (EDT) 
...
access expires, you will lose access to U-M Canvas and all related materials.<br>
<br>
The Responsible Use of Information Resources [Standard Practice Guide (SPG) 601.07] applies to all members of the 
...
review, expulsion from the University, termination of employment, legal action or other disciplinary action. 
For information about responsible and appropriate use, see https://it.umich.edu/information-technology-policies.<br>
<br>
If you have questions about the contents of this message, or if you are in need of Summer Program computing support, 
send email to icpsr-sptechsupp@umich.edu.<br>
<br>
...
To: {}
Subject: 
This is a test message because I dont have the boilerplate email yet, here is a link to the documentation homepage 
www.google.com<br>
<br>
"""
username_msg = """\
...
parser.add_argument("-c", "--compsupp", action='store_true', help="Sends support documentation email")
        ...
        for row in csv_reader:
            ...
            if args.intro:
                ...
                if role == 'Instructor':
                    ...
                    exit(1)
            if args.compsupp:
                compsupp_msg = compsupp_msg.format(sender_icpsr, receiver)
                server.sendmail(sender, receiver, compsupp_msg + signature)
